...
import {
  Book, Link, FileText, Video, Music, BarChart, Computer, Smartphone, Globe, FileImage,
  FileCog, FileCode, Package, Calendar, Mail, Users, Plane, PenTool, Palette, Headphones,
  Camera, CloudRain, Lock, Heart, Star, Map, Store, Zap, Radio, MessageCircle, User, Building,
  Archive, Database, ShoppingCart, Truck, Coffee, Briefcase, Banknote, LayoutDashboard, Settings
} from "lucide-react";
